...
def taskboard_input_view(page: ft.Page) -> ft.View:
    ...
    task_desc = ft.TextField(
        hint_text="e.g. Feed kibble/prescription meds",
        width=340,
    ...
    # normal functions can't call asynch functions
    async def add_pet(e):
        ...
        pets_ref.set({
            "pets": firestore.ArrayUnion([{
                "Set Pet": task_name.value,
                "name": pet_selection.value,
    ...
    form = ft.Container(
        ...
        content=ft.Column(
            ...
            controls=[
                ...
                labeled_input("Description", task_desc),
                error_text,
            ],
        ),
    )
